...
public class Form2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		c1.setMaxAge(60*60*24*365); //seconds
		...
		*/
		...
		out.println("Yrs of Experience <input type=text name=t4 size=24> <br><br>");
		out.println("Lang Known <input type=text name=t5 size=24> <br><br>");
